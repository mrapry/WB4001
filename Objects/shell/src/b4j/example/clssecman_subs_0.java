...
try {
		Debug.PushSubsStack("Initialize (clssecman) ","clssecman",5,__ref.getField(false, "ba"),__ref,6);
...
try {
		Debug.PushSubsStack("WebSocket_Connected (clssecman) ","clssecman",5,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (clssecman) ","clssecman",5,__ref.getField(false, "ba"),__ref,14);
