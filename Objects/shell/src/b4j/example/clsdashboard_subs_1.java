...
;
 BA.debugLineNum = 24;BA.debugLine="Log(unit)";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("Log",(Object)(_unit));
 BA.debugLineNum = 25;BA.debugLine="ws.RunFunction(\"get_unit\",Array (unit))";
...
__ref.getField(false,"_ws").runVoidMethod ("RunFunction",(Object)(BA.ObjectToString("get_unit")),(Object)(parent.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_unit)})))));
 BA.debugLineNum = 26;BA.debugLine="ws.Flush";
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (clsdashboard) ","clsdashboard",1,__ref.getField(false, "ba"),__ref,29);
