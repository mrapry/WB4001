...
clsmonitoring._cls = RemoteObject.createNew ("b4j.example.clsservice");__ref.setField("_cls",clsmonitoring._cls);
 //BA.debugLineNum = 5;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _initialize(RemoteObject __ref,RemoteObject _ba) throws Exception{
try {
		Debug.PushSubsStack("Initialize (clsmonitoring) ","clsmonitoring",3,__ref.getField(false, "ba"),__ref,7);
...
public ResumableSub_logout_Click(b4j.example.clsmonitoring parent,RemoteObject __ref,RemoteObject _params) {
this.parent = parent;
this.__ref = __ref;
...
try {
		Debug.PushSubsStack("logout_Click (clsmonitoring) ","clsmonitoring",3,__ref.getField(false, "ba"),__ref,15);
...
try {
		Debug.PushSubsStack("WebSocket_Connected (clsmonitoring) ","clsmonitoring",3,__ref.getField(false, "ba"),__ref,11);
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (clsmonitoring) ","clsmonitoring",3,__ref.getField(false, "ba"),__ref,21);
