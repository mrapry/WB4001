...
Debug.ShouldStop(512);
 BA.debugLineNum = 11;BA.debugLine="Log(\"b4j di hit di id=coba_hit \")";
Debug.ShouldStop(1024);
clsdashboard.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("b4j di hit di id=coba_hit ")));
 BA.debugLineNum = 12;BA.debugLine="ws.RunFunction(\"getData\",Null)";
...
__ref.getField(false,"_ws").runVoidMethod ("RunFunction",(Object)(BA.ObjectToString("getData")),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), clsdashboard.__c.getField(false,"Null")));
 BA.debugLineNum = 13;BA.debugLine="ws.Flush";
...
try {
		Debug.PushSubsStack("WebSocket_Connected (clsdashboard) ","clsdashboard",3,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (clsdashboard) ","clsdashboard",3,__ref.getField(false, "ba"),__ref,20);
if (RapidSub.canDelegate("websocket_disconnected")) return __ref.runUserSub(false, "clsdashboard","websocket_disconnected", __ref);
 BA.debugLineNum = 20;BA.debugLine="Private Sub WebSocket_Disconnected";
